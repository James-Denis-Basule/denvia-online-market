...
const env = {
  ...
  paymentProviderMode:
    parsedEnv.data.PAYMENT_PROVIDER_MODE,

  deliveryProviderMode:
    parsedEnv.data.DELIVERY_PROVIDER_MODE,

  stripeSecretKey:
    parsedEnv.data.STRIPE_SECRET_KEY,

  flutterwaveSecretKey:
    parsedEnv.data.FLUTTERWAVE_SECRET_KEY,

  flutterwaveEncryptionKey:
    parsedEnv.data.FLUTTERWAVE_ENCRYPTION_KEY,

  courierApiKey:
    parsedEnv.data.COURIER_API_KEY,

  paymentWebhookSecret:
    parsedEnv.data.PAYMENT_WEBHOOK_SECRET,

  deliveryWebhookSecret:
    parsedEnv.data.DELIVERY_WEBHOOK_SECRET,
