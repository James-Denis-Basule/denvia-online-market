...
function ProductsPage() {
  ...
  async function handleAddToCart(
    ...
    try {
      ...
      setCartError(`Unable to add ${product.name} to your cart.`);
    } finally {
                  ...
                  return (
                    ...
                    >
                          ...
                          <div className="flex h-full items-center justify-center bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-100">
                            <div className="flex flex-col items-center justify-center">
                              ...
                              >
                                ...
                                <path d="M3 16l5-5 4 4 2.5-2.5L21 17" />
                              </svg>
                      ...
                      <div className="p-4">
                        <div className="flex items-center gap-2.5">
                          {product.business?.logo ? (
                            ...
                            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-50 text-[11px] font-bold text-blue-700">
                              {product.business?.name?.slice(0, 2).toUpperCase() ?? 'BU'}
                            </div>
                          )}
                        ...
                        <h3 className="mt-2 line-clamp-2 min-h-[3rem] text-base font-bold leading-5.5 text-gray-900 transition group-hover:text-blue-700">
                          {product.name}
                        </h3>
                        ...
                        <button
                          ...
                          className={`mt-3 flex w-full items-center justify-center gap-2 rounded-xl px-4 py-2.5 text-sm font-bold text-white shadow-lg transition ${
                            isOutOfStock
                              ? 'cursor-not-allowed bg-gray-300 shadow-none'
                              : addedProductId === product._id
                                ? 'bg-green-600 shadow-green-100'
                                : 'bg-blue-600 shadow-blue-100 hover:-translate-y-0.5 hover:bg-blue-700 hover:shadow-xl'
                          }`}
                        >
                          {addingProductId === product._id ? (
                            <>
                            ...
                            <>
                              <svg
                                ...
                                aria-hidden="true"
                              >
                                <path d="M3 4h2l2.2 10.2a2 2 0 0 0 2 1.6h7.6a2 2 0 0 0 2-1.6L21 7H6" />
